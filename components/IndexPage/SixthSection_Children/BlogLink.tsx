...
export default function BlogLink() {
  ...
  return (
    <motion.div
      ...
      className="relative flex flex-col gap-3 p-8 bg-[url(https://images.pexels.com/photos/4082570/pexels-photo-4082570.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)] bg-center object-cover rounded-2xl"
    >
      ...
      {isHovered && (
        <motion.button
          ...
          className="w-fit flex items-center p-2 px-3 absolute top-[50%] left-[50%] bg-black rounded-lg"
        >
          <svg
